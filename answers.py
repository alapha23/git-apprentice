...
mydict[2] = 20
print(mydict)
#cannot run and no error message
...
return mydict[key]
print(mydict)
#cannot run due to indentation error
...
return mymax
print(mymax)
#cannot run and error "'return' outside function"
#alternative answer
for i in lst:
  if i == max(lst):
      return i
  print(i)
#cannot run error "'return' outside function"
...
def MultiplyALL(lst):
    ...
    return (result)
print(result)
# cannot run error "name 'result' is not defined"